...
# NOTE:過去の履歴三つの場合
cat ./NUCC/clean_all.csv |\
# [SEP]の間になにもない状態を許さないのを廃止 2021.10.20
...
perl -ne 'BEGIN{$p3="";$p2="";$p1=""} chomp; if($_ ne "(EOD)"){print $p3 . "[SEP]" . $p2 . "[SEP]" . $p1 . "</s>" . $_ . "\n";}else{$p2="";$p1="";$_="";} $p3=$p2; $p2=$p1; $p1=$_;' > ./NUCC/data.train.txt
# NOTE: 過去の履歴一つの場合
# cat clean_all.csv |\
...
shuf ./NUCC/data.train.txt | head -n 6000 > ./NUCC/data.validation.txt
